...
//			}
			final String string4 = "{\"tmp\":\"" + 49.8 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
			try {
			...
			final String string5 = "{\"tmp\":\"" + 50.0 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
			try {
			...
			final String string6 = "{\"tmp\":\"" + 49.8 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
			try {
			...
			final String string7 = "{\"tmp\":\"" + 49.7 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
			try {
			...
			final String string8 = "{\"tmp\":\"" + 49.5 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
			try {
			...
			final String string9 = "{\"tmp\":\"" + 48.0 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
			try {
...
//			final String string11 = "{\"tmp\":\"" + 18.0 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
//					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
//					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
//					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
//			try {
...
//			final String string12 = "{\"tmp\":\"" + 18.0 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
//					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
//					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
//					+ "\",\"mov\":\"x\",\"sens\":\"eth\"}";
//			try {
...
//			final String string13 = "{\"tmp\":\"" + 18.0 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
//					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
//					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + -20
//					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
//			try {
...
//			final String string14 = "{\"tmp\":\"" + 18.0 + "\",\"hum\":\"" + 35.0 + "\",\"dat\":\""
//					+ LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\",\"tim\":\""
//					+ LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "\",\"cell\":\"" + 20
//					+ "\",\"mov\":\"" + 0 + "\",\"sens\":\"eth\"}";
//			try {
